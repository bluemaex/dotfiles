...
# ~/.osx — http://mths.be/osx rev: a5a012f42f868df66e8575aa4a4b8e6dda6f7efc
...
sudo scutil --set ComputerName "maexbook"
sudo scutil --set HostName "maexbook"
sudo scutil --set LocalHostName "maexbook"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "maexbook"
...
defaults write com.apple.dock largesize -float 100.3981

# minize into application
