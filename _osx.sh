...
sudo scutil --set ComputerName "airmaex"
sudo scutil --set HostName "airmaex"
sudo scutil --set LocalHostName "airmaex"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "airmaex"
